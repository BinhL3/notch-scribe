...
export const SettingContainer: React.FC<SettingContainerProps> = ({
  ...
  const horizontalContainerClasses = grouped
    ? "group flex items-center justify-between min-h-12 px-4 p-2"
    : "group flex items-center justify-between min-h-12 px-4 p-2 rounded-lg border border-mid-gray/20";
